...
Based on the above paragraph, there's no difference with the projects approach. 
...
My work is to reduce the gap between math and algorithms. Until this gap is bellow by a suitable threshold.
